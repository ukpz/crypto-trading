  ...
  return (
    <View className="flex-1 justify-between" style={{ marginTop: insets.top, marginBottom: insets.top }}>
      ...
      <View className="flex-row items-center m-4">
        ...
        <Text className="text-2xl font-semibold mx-8">Buy Bitcoin <Text className="text-sm text-gray-500">(BTC)</Text></Text>
        <Pressable className="bg-red-100 px-3 py-2 rounded-full ms-auto">
          <Text className="text-red-600 font-semibold text-sm">SELL BTC</Text>
        </Pressable>
      </View>
