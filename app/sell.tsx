  ...
  return (
    <View className="flex-1 justify-between" style={{ marginTop: insets.top, marginBottom: insets.top }}>
      ...
      <View className="flex-row items-center m-4">
        ...
        <Text className="text-2xl font-semibold mx-8">Sell Bitcoin <Text className="text-sm text-gray-500">(BTC)</Text></Text>
        <Pressable className="bg-green-100 px-3 py-2 rounded-full ms-auto">
          <Text className="text-green-600 font-semibold text-sm">BUY BTC</Text>
        </Pressable>
      </View>

      {/* Amount Section */}
      <View className="m-4">
        <Text className="text-center text-gray-500 text-sm mb-2">BTC Amount</Text>
        <Text className="text-center text-5xl font-semibold mb-8">{amount || 0.00}</Text>
        <Text className="text-center text-gray-500 text-sm mb-6">
          Min 0.0001 BTC - Max 10,000 BTC
        </Text>
        <Text className="text-center text-gray-600 text-base font-bold mb-3">
          Available Balance: {balance.toLocaleString()} BTC
        </Text>
