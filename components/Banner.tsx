...
interface Props { title: string, subtitle: string, color: string, image: string, btnText: string, onPress?: () => void }

const Banner: React.FC<Props> = ({ title, subtitle, color, image, btnText, onPress }) => {
